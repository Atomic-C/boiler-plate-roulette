...
namespace BoilerPlateRouletteSolution.Models
{
    public class NumberStats
    {
        ...
        public double Number { get; set; } // We will have a total of 37 numbers here.
        ...
        public double OddPercentage { get; set; }
        public double EvenPercentage { get; set; }
        public double OddCount { get; set; }
        public double EvenCount { get; set; }
